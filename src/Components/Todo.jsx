...
import axios from "axios" ; 
 export const Todo = () =>{
const todos = useSelector(store => store.todo.todo) // useSelector decide which components goes to rerender // if we return store only then entire store goes to re-render 
